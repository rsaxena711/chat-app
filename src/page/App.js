        ...
        <Row>
          <Col className='left-sidebar' xs="4">
            <Row className='left-sidebar-header'>
              <Row className='d-flex align-items-center left-top' style={{ backgroundColor: "#205853" }}>
                <Col>
                  {" "}
              ...
              <Row style={{ margin: "auto", paddingTop: "2px",paddingBottom:"10px" , backgroundColor:"white"}}>
          ...
          <Col className='right-sidebar' xs='8'>
            <Routes>
              <Route
